...
shim-native:
	...
	$(native_cc) -arch x86_64 -arch i386 -shared -o $(lib_dir)/libponyjpeg-osx.a $(build_dir)/jpeg.o shim/libjpeg/macosx-build/lib/libjpeg.a
...
shim-ios:
	...
	$(iphonesdk_clang) -arch armv7 -arch armv7s -arch arm64 -mios-version-min=10.0 -isysroot $(iphonesdk_isysroot) -shared -stdlib=libc++ -o $(lib_dir)/libponyjpeg-ios.a $(build_dir)/jpeg.o shim/libjpeg/iphone-build/lib/libjpeg.a
